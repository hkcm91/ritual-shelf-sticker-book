...
import { useAnimationDetection } from './useAnimationDetection';
import LottieSticker from './LottieSticker';
import ImageSticker from './ImageSticker';
import StickerErrorState from './StickerErrorState';
import AltKeyHelper from './AltKeyHelper';
...
const StickerContent = forwardRef<HTMLDivElement, StickerContentProps>(({
  ...
  try {
    ...
    const stickerStyle = {
      ...
      // Always set z-index to a high value to ensure stickers are on top of books and dividers
      zIndex: 100
    };
